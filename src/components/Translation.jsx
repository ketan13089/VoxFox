        ...
        <>
            ...
            {!translating && (<div className='flex flex-col gap-1 mb-4'>
                ...
                <div className='flex items-stretch gap-2 sm:gap-4' >
                    ...
                    <button onClick={generateTranslation} className='specialBtn bg-white rounded-lg px-3 py-2 rounded-lg text-orange-400 hover:text-orange-600 duration-200'>Translate</button>
                </div>
            </div>)}
        </>
    )
